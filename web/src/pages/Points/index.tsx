    ...
    return (
        <div id="page-points">
            ...
            <div className="content">
                <span>Mostrando locais em <strong>{city}, {uf}</strong>.</span>
                <span><strong>{points.length} locais</strong> encontrados.</span>
            </div>
                ...
                <>
                    {points.length === 0 ? (
                        <div className="not-items-indicator">
                            <h2>Ops!</h2>
                            <span>Ainda não foram cadastrados doações nessa cidade!</span>
                        </div>
                    ) : (
                        <div className="items">
